const e="https://api.thecatapi.com/v1",t="live_P0dQ7oUYgA6D9xiTVrZ5kawCo8KiAc3cNxiSDEmamQIcEapg6ZwUPPwPra7YzvoS";async function r(){try{let r=await fetch(`${e}/breeds?api_key=${t}`);if(!r.ok)throw Error(r.status);return await r.json()}catch(e){throw Error(`Error fetching breeds: ${e.message}`)}}async function a(r){try{let a=await fetch(`${e}/images/search?api_key=${t}&breed_ids=${r}`);if(!a.ok)throw Error(a.status);return await a.json()}catch(e){throw Error(`Error fetching cat by breed: ${e.message}`)}}const c=document.querySelector("select"),n=document.querySelector(".cat-card");function o(){console.log("Error fetching breeds")}c.addEventListener("change",function(e){a(e.currentTarget.value).then(e=>{let{url:t,breeds:r}=e[0];n.innerHTML=`<div class="catCard">
...
//# sourceMappingURL=index.e5112eed.js.map
